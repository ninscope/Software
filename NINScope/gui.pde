...
public void createGUI(){
  ...
  ScopeList = new GDropList(this, 10, 320, 380, 220, 10);
  ...
  Sli_ExpoCam1.setLimits(25000, 0, 27532);
  ...
  Sli_GainCam1.setLimits(400, 0, 4000);
  Sli_GainCam1.setNbrTicks(50);
  ...
  Btn_ConnectBehav = new GButton(this, 410, 350, 70, 30);
  ...
  sketchPad2 = new GSketchPad(this, 480, 680, 80, 60);
  Lbl_BlackOffset = new GLabel(this, 10, 640, 90, 20);
  Lbl_BlackOffset.setText("Focus");
  Lbl_BlackOffset.setTextBold();
  Lbl_BlackOffset.setOpaque(false);
  Sli_FocusCam1 = new GSlider(this, 10, 660, 380, 30, 10.0);
  Sli_FocusCam1.setLimits(0, 0, 255);
  Sli_FocusCam1.setNumberFormat(G4P.INTEGER, 0);
  Sli_FocusCam1.setOpaque(false);
  LbL_Gsens = new GLabel(this, 410, 420, 150, 20);
  ...
  LbL_ExpoStat.setText("30,00mS - 25000");
  LbL_ExpoStat.setTextItalic();
  LbL_ExpoStat.setOpaque(false);
  LbL_GainStat = new GLabel(this, 240, 580, 150, 20);
  LbL_GainStat.setTextAlign(GAlign.RIGHT, GAlign.MIDDLE);
  LbL_GainStat.setText("400");
  LbL_GainStat.setTextItalic();
  LbL_GainStat.setOpaque(false);
  LbL_FocusStat = new GLabel(this, 240, 640, 150, 20);
  LbL_FocusStat.setTextAlign(GAlign.RIGHT, GAlign.MIDDLE);
  LbL_FocusStat.setText("0");
  LbL_FocusStat.setTextItalic();
  LbL_FocusStat.setOpaque(false);
  ...
  Scope2List = new GDropList(this, 750, 320, 380, 220, 10);
  ...
  Sli_ExpoCam2.setLimits(25000, 0, 27532);
  ...
  Sli_GainCam2.setLimits(512, 0, 4000);
  ...
  LbLFrameRate2 = new GLabel(this, 750, 600, 80, 20);
  ...
  LblDropScp2 = new GLabel(this, 840, 600, 80, 20);
  ...
  Drpl_BehaveFormat = new GDropList(this, 640, 350, 90, 80, 3);
  ...
  WindowZoomCam1 = GWindow.getWindow(this, "Zoom Cam 1", 0, 0, 752, 580, JAVA2D);
  WindowZoomCam1.noLoop();
  Sld_Cam1 = new GSlider2D(WindowZoomCam1, 286, 490, 180, 80);
  ...
  SettingsWnd = GWindow.getWindow(this, "Settings", 0, 0, 455, 500, JAVA2D);
  SettingsWnd.noLoop();
  ...
  ChkBox_TriggerInput.setText("Trigger Input ( active low)");
  ...
  LbL_Title_Temperature = new GLabel(SettingsWnd, 20, 330, 80, 20);
  ...
  WindowZoomCam2 = GWindow.getWindow(this, "Zoom Cam 2", 0, 0, 752, 580, JAVA2D);
  WindowZoomCam2.noLoop();
  Sld_Cam2 = new GSlider2D(WindowZoomCam2, 286, 490, 180, 80);
...
GSlider Sli_FocusCam1; 
GLabel LbL_Gsens; 
GLabel LbL_ExpoStat; 
GLabel LbL_GainStat; 
GLabel LbL_FocusStat; 
GLabel LbL_ExciStat; 
